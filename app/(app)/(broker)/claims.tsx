...
export default function BrokerClaimsScreen() {
  ...
  const descriptions = selectedClaim && detail ? buildCrosslistingDescriptions(detail) : [];
      ...
      {loading ? (
        ...
        <ScrollView className="mt-2 flex-1" contentContainerClassName="gap-5 pb-10">
          ...
          <View className="flex-row items-start gap-5">
            <View className="w-[360px]">{queue}</View>
            <View className="min-w-0 flex-1">{detailPane}</View>
          </View>
        </ScrollView>
      ) : (
