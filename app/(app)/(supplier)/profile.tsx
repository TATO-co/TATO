...
export default function SupplierProfileScreen() {
  ...
  return (
    <ModeShell
      ...
      {canBroker ? (
        <Pressable
          className="mt-5 rounded-full bg-tato-accent py-3.5 hover:bg-tato-accentStrong focus:bg-tato-accentStrong"
      ...
      <Pressable
        className="mt-3 rounded-full border border-tato-line bg-tato-panelSoft py-3.5 hover:bg-[#1a3158] focus:bg-[#1a3158]"
